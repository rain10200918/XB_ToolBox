...
class XB_llamaMiniMaxRef2vaPreset:
    ...
    _CUTS = XB_llamaMiniMaxPreset._CUTS
    _MUSIC = XB_llamaMiniMaxPreset._MUSIC
    _MUSIC_HINTS = XB_llamaMiniMaxPreset._MUSIC_HINTS
    _ASPECTS = XB_llamaMiniMaxPreset._ASPECTS
    _ASPECT_HINTS = XB_llamaMiniMaxPreset._ASPECT_HINTS
